...
A calm, low-chrome dark theme. The aim is for the target view and the
session metrics to dominate, with everything else fading into the
background. No bordered cards. Spacing groups things.
"""
