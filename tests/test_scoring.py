...
def test_outward_scoring_awards_smallest_ring_shot_is_inside():
    ...
    # Outward scoring: the ring boundary the shot is between (25-50)
    # scores the outer ring's label.
    assert score_shot(40.0, 0.0, rings, scoring_direction="outward") == "10"
    # Shot at 20mm is between 10mm and 25mm boundaries.
    # Outward scoring: scores the outer ring (25mm → "5").
...
def test_outward_scoring_with_shot_diameter():
    ...
    # Shot centre at 12mm with 4mm diameter: edge is at 10mm,
    # which touches the 10mm ring boundary. Outward scoring:
    # the shot is between 10mm and 30mm, scores "5".
