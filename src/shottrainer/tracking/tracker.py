...
There's no calibration step. The conversion from pixels to mm is
recalculated every frame from the detected circle's size, so
small changes in distance (you shift on the bench, the rifle
moves a bit) don't throw the trace off.
