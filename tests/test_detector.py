...
def test_lock_prefers_close_blob_over_distant_one():
    ...
    # Now both blobs in the same frame: the original at 320, and a
    # competing blob far enough away that it's outside the lock
    # search window. The lock keeps the tracker on the original.
