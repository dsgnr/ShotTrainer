"""User preferences, as a plain dataclass.

Loaded from disk by :mod:`app.settings`, applied to the running
app by :mod:`app.controller`, edited from
:mod:`ui.preferences_dialog`. Lives at the app layer so the
persistence code doesn't end up depending on Qt.
"""
